...
intl = transform(intl, Region = reorder(Region, -PercentOfIntl)) # decreasing order of Percentage
...
# Reorder the data as merge has messed things up
...
str(households)
# Here we do no know what to pass in the aesthetics of ggplot as we need it to be in the form of "year group fraction"
# the melt function in reshape2 will help with that
